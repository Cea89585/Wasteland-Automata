...
export const Resources = {
  ...
  glowfish: 'Glowfish',
  rustyCan: 'Rusty Can',
  glowingAlgae: 'Glowing Algae',
  goldenMinnow: 'Golden Minnow',
  sludgeBass: 'Sludge Bass',
  irradiatedCarp: 'Irradiated Carp',
  bioLuminescentMoss: 'Bio-Luminescent Moss',
  oldBoot: 'Old Boot',
  goldenBass: 'Golden Bass',
  reactorCoreShard: 'Reactor Core Shard',
  goldenGlowfish: 'Golden Glowfish',
  bunkerCarp: 'Bunker Carp',
  caveEel: 'Cave Eel',
  armoredFish: 'Armored Fish',
  militaryRation: 'Military Ration',
  waterloggedDataChip: 'Waterlogged Data Chip',
  goldenEel: 'Golden Eel',
  preWarTech: 'Pre-War Tech',
  acidSwimmer: 'Acid Swimmer',
  toxicTrout: 'Toxic Trout',
  chemicalCarp: 'Chemical Carp',
  strangeCrystal: 'Strange Crystal',
  chemicalSample: 'Chemical Sample',
  goldenSwimmer: 'Golden Swimmer',
  experimentalCompound: 'Experimental Compound',
  craterDweller: 'Crater Dweller',
  depthFish: 'Depth Fish',
  meteorFragment: 'Meteor Fragment',
  cosmicDebris: 'Cosmic Debris',
  goldenCraterFish: 'Golden Crater Fish',
  meteoriteShard: 'Meteorite Shard',
  ancientArtifact: 'Ancient Artifact',
  urbanScavengerFish: 'Urban Scavenger Fish',
  rubbleSwimmer: 'Rubble Swimmer',
  buildingMaterial: 'Building Material',
  preWarCurrency: 'Pre-War Currency',
  glassShard: 'Glass Shard',
  goldenCityFish: 'Golden City Fish',
  pristinePreWarItem: 'Pristine Pre-War Item',
  treasureCache: 'Treasure Cache',
} as const;
